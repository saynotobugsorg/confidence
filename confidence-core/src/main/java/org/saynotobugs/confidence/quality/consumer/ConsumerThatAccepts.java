...
public final class ConsumerThatAccepts<T> extends QualityComposition<Consumer<T>>
{
    ...
    {
        this(new Delimited(new TextDescription("Consumer that accepts"), new ValueDescription(valueSupplier.get())),
            new Delimited(new TextDescription("Consumer that accepts"), new ValueDescription(valueSupplier.get()), new TextDescription("threw")),
            valueSupplier);
    }
    ...
    {
        this(new Delimited(new TextDescription("Consumer that accepts"), new ValueDescription(value)),
            new Delimited(new TextDescription("Consumer that accepts"), new ValueDescription(value), new TextDescription("threw")),
            () -> value);
    }
}
