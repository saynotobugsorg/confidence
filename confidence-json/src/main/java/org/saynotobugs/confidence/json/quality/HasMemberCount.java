...
public final class HasMemberCount extends QualityComposition<JsonObjectAdapter>
{
    public HasMemberCount(int delegate)
    {
        this(new EqualTo<>(delegate));
    }


    public HasMemberCount(Quality<? super Integer> delegate)
    {
        super(new Has<>("member count", JsonObjectAdapter::length, delegate));
    }
}
