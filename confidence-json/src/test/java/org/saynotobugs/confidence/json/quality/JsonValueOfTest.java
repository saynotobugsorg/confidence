    ...
    void test() throws IOException
    {
        assertThat(new JsonValueOf(new Object(new Anything())),
            new AllOf<>(
                ...
                new Fails<>(new org.dmfs.express.json.elementary.Array(), "JsonValue object not an object"),
                new Fails<>(new org.dmfs.express.json.elementary.String("123"), "JsonValue object not an object"),
                new HasDescription("JsonValue object { <anything> }")));
    }
}